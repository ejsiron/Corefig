...
function StartVM($object)
{
	...
	#Output to Logfile
	$TextStrings.LogVirtualMachineStarted -f $Logdate, $object | Out-File -filepath $logfile -append
...
function StopVM($object)
{
	...
	#Output to Logfile
	$TextStrings.LogVirtualMachineStopped -f $Logdate, $object | Out-File -filepath $logfile -append
}
