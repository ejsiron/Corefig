...
function OK
{
	...
	if ($RadioButton1.Checked)
	{
		...
		#Output to Logfile
		$TextStrings.LogCommandExecuted -f $Logdate, ("Set-ItemProperty -Name fDenyTSConnections -Path " + $PathMain + " -Value 1") | Out-File -FilePath $logfile -Append
		$TextStrings.LogRuleGroupChanged -f $Logdate, $TextStrings.RemoteDesktop, $TextStrings.Disabled | Out-File -FilePath $logfile -Append
	}
	if ($RadioButton2.Checked)
	{
		...
		#Output to Logfile
		$TextStrings.LogCommandExecuted -f $Logdate, ("Set-ItemProperty -Name fDenyTSConnections -Path " + $PathMain + " -Value 0") | Out-File -FilePath $logfile -Append
		$TextStrings.LogCommandExecuted -f $Logdate, ("Set-ItemProperty -Name UserAuthentication -Path " + $PathMain + " -Value 0") | Out-File -filepath $logfile -append
		$TextStrings.LogRuleGroupChanged -f $Logdate, $TextStrings.RemoteDesktop, $TextStrings.Enabled | Out-File -filepath $logfile -append
	}
	if ($RadioButton3.Checked)
	{
		...
		#Output to Logfile
		$TextStrings.LogCommandExecuted -f $Logdate, ("Set-ItemProperty -Name fDenyTSConnections -Path " + $PathMain + " -Value 0") | Out-File -filepath $logfile -append
		$TextStrings.LogCommandExecuted -f $Logdate, ("Set-ItemProperty -Name UserAuthentication -Path " + $PathMain + " -Value 1") | Out-File -filepath $logfile -append
		$TextStrings.LogRuleGroupChanged -f $Logdate, $TextStrings.RemoteDesktop, $TextStrings.Enabled | Out-File -filepath $logfile -append
	}
	Get-Status
